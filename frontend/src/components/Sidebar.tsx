      ...
      <div className="sticky bottom-4 border-t border-white/5 pt-4 bg-[#080810]">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 overflow-visible">
            <div className="w-10 h-10 bg-gradient-to-br from-violet-600 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold shrink-0 shadow-lg shadow-cyan-500/30">
              {avatarLetter}
            </div>
            <div className="min-w-0">
              ...
              <div className="text-xs text-slate-500">Jellyfin Connected</div>
            </div>
          </div>
