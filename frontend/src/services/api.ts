...
export const getRecommendations = async (targetItemId: string, libraryId: string, options?: { type?: string; genre?: string; mood?: string; refresh?: boolean }): Promise<JellyfinItem[]> => {
